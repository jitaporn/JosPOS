const CACHE='jos-pos-v1.6.0';
const ASSETS=['./','./index.html','./style.css','./product.css','./app.js','./product.js','./features.js','./finance.js','./stock-engine.js','./stock-receive.js','./lot-engine.js','./manifest.webmanifest'];
